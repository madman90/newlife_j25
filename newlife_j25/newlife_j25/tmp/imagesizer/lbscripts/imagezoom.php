<?PHP
/*------------------------------------------------------------------------
# imagezoom.php for PLG - SYSTEM - IMAGESIZER
# ------------------------------------------------------------------------
...
if(file_exists(JPATH_SITE.DS.$path.$l.'_imagezoom.js')){
	$document->addScript($path.$l.'_imagezoom.js');
}else{
	$document->addScript($path.'imagezoom.js');	
}
unset($path);
