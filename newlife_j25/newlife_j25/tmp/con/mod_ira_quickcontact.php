...
$document->addScript(JURI::base(true) . '/modules/mod_ira_quickcontact/assets/js/script.js');
$document->addStylesheet(JURI::base(true) . '/modules/mod_ira_quickcontact/assets/css/style.css');

require(JModuleHelper::getLayoutPath('mod_ira_quickcontact'));