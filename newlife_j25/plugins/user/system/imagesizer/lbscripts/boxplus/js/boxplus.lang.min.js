...
*/
(function(){function d(c,a){var b=a?c+"-"+a:c;b=e[b]?b:e[c]?c:"";var f={language:"",first:"",prev:"",next:"",last:"",start:"",stop:"",close:"",enlarge:"",shrink:"",download:"",metadata:"",notFound:"",unknownType:""};b&&$extend(f,e[b]);var d={language:"language",first:"first",prev:"prev",next:"next",last:"last",start:"start",stop:"stop",close:"close",enlarge:"enlarge",shrink:"shrink",download:"download",metadata:"metadata",notFound:"not-found",unknownType:"unknown-type"};$each(f,function(a,c){var b=
